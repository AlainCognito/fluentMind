...
export const challenges: Challenge[] = [
  ...
  {
    type: "video",
    text: "The speaker mentioned that learning a language requires ___, ___ and ___.",
    blanks: ["patience", "practice", "consistency"],
    hints: ["ability to wait calmly", "repeated exercise to improve skill", "doing something regularly"],
    source: { title: "Language Learning Tips", author: "Education Channel", url: "https://www.ryanair.com/" },
  ...
  // Vous pouvez ajouter autant de nouveaux défis que vous voulez ici
  {
    type: "article",
    text: "The students were ___ to submit their ___ before the deadline.",
    blanks: ["required", "assignments"],
    hints: ["obligated or needed", "tasks given to complete"],
    source: { title: "Academic Guidelines", author: "University Press", url: "#" },
    difficulty: "medium",
  },
  {
    type: "article",
    text: "The chef ___ the ingredients before ___ them into the pot.",
    blanks: ["chopped", "adding"],
    hints: ["cut into pieces", "putting in or including"],
    source: { title: "Cooking Basics", author: "Culinary Institute", url: "#" },
    difficulty: "easy",
  },
  {
    type: "article",
    text: "Regular ___ is essential for maintaining good ___ health.",
    blanks: ["exercise", "physical"],
    hints: ["physical activity", "relating to the body"],
    source: { title: "Health Magazine", author: "Wellness Publications", url: "#" },
    difficulty: "easy",
  },
  {
    type: "article",
    text: "The ___ of the novel takes place in a small ___ town.",
    blanks: ["setting", "coastal"],
    hints: ["location where something happens", "near the sea or ocean"],
    source: { title: "Literary Analysis", author: "Book Review Weekly", url: "#" },
    difficulty: "medium",
  },
  {
    type: "article",
    text: "Scientists are ___ new methods to ___ plastic waste in the oceans.",
    blanks: ["developing", "reduce"],
    hints: ["creating or inventing", "make less or smaller in amount"],
    source: { title: "Environmental Research", author: "Science Today", url: "#" },
    difficulty: "hard",
  },
]
